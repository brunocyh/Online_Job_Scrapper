...
if __name__ == "__main__":    
    ...
    pri = ['parttime ','junior ','casual ']
    search_term = ['barista','job', 'data entry', 'resturant']
    ...
    try:
        ...
        f_name = '{}_pt_jobs{}'.format(loc, tstmp)
        result.export_csv('{}/pt_job_dataset/{}.csv'.format(cdir, f_name))
    ...
    result2 = ca.crawler(concern_key_words, '{}/pt_job_dataset/{}.csv'.format(cdir, f_name))
    
    try: 
        result2.crawl_content(j_count)
        result2.export_csv('{}/pt_job_dataset/{}_analysed.csv'.format(cdir, f_name))    
    ...
    try:
        ytd_name = alarm.find_yesterday("{}/pt_job_dataset".format(cdir), more = 1)
        ytd_name = '{}/pt_job_dataset/{}'.format(cdir, ytd_name)
        newest_file = '{}/pt_job_dataset/{}_analysed.csv'.format(cdir, f_name)
